<x-modal>
        ...
        <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6">
                    ...
                    <select id="category" name="category" wire:model="category" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-200 sm:text-sm" required >
    ...
    <x-slot name="buttons">
        ...
        <x-jet-button wire:click='update' wire:loading.attr="disabled">Išsaugoti</x-jet-button>&nbsp
