<x-modal>
        ...
        <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6">
                    ...
                    <select id="date_type" name="date_type" wire:model="date_type" wire:change="set_type" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-200 sm:text-sm" required/>
    ...
    <x-slot name="buttons">
        <span wire:loading wire:loading.delay wire:target="save" class="px-2 inline-flex text-xs leading-5 font-semibold text-gray-700">
            Išsaugoma...
        </span>
        <x-jet-button wire:click='save' wire:loading.attr="disabled">Išsaugoti</x-jet-button>&nbsp
        <x-jet-button wire:click="$emit('closeModal')" wire:loading.attr="disabled">Atšaukti</x-jet-button>&nbsp
